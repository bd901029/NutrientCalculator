...
@IBDesignable
class LBZSpinner : UIView, UITableViewDelegate, UITableViewDataSource {
    ...
    //public variable
	static var INDEX_NOTHING: Int = 0
	...
	fileprivate(set) internal var selectedIndex: Int = INDEX_NOTHING
